...
# --- 🚀 THE UNBREAKABLE ANALYTICS PIPELINE ---
...
def get_analytics():
    ...
    # DEFAULT TO "PK" AND "CURRENT MONTH" IF NOT PROVIDED
    ...
    # =========================================================================
    # THE FIX: BLIND FETCH LOOP (NO EARLY EXITS, NO BRAKES)
    # We download every single page for the target region to guarantee no missed days.
    # =========================================================================
    ...
    for _ in range(100):  # Allows up to 50,000 records
        ...
        try:
            ...
            if res_json.get("code") != 0:
                # If Feishu rejects the region filter, drop it and fetch everything
            ...
            # KEEP DOWNLOADING UNTIL FEISHU CONFIRMS WE HAVE EVERYTHING
    ...
    for item in all_items:
        ...
        # ENFORCE EXACT DATE IN LOCAL MEMORY
