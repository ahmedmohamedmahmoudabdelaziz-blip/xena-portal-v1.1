    ...
    for file_path in tried_paths:
        if os.path.exists(file_path):
            try:
                ...
                # wrong. "build_mtime" (the file's real on-disk last-modified time,
                # not just when this process happened to read it) lets callers like
                # get_requests_table_snapshot()/get_points_table_snapshot() detect and
                # route around a stale build instead of trusting it blindly.
                try:
