...
def get_analytics():
    ...
    # =========================================================================
    # THE FIX: DEFAULT PARAMETERS (Exactly as you specified)
    # =========================================================================
    ...
    # =========================================================================
    # THE FIX: BLIND FETCH (Bypass Feishu "operator" syntax errors entirely)
    # By omitting payload["filter"], Feishu can never reject the request. 
    # =========================================================================
    ...
    # =========================================================================
    # LOCAL DATA AGGREGATOR (Perfectly matched to Video layout)
    # =========================================================================
    stats = {
    ...
    for item in all_items:
        ...
        # 2. ENFORCE EXACT REGION FILTER (Defaulting to PK)
        ...
        # =========================================================================
        # 3. KPI ASSIGNMENT ("CONTAINS" logic from video)
        # =========================================================================
